...
class Schemes {
  ...
  static Scheme paperDark = Scheme(
    name: 'Paper Dark',
    light: Colors.white,
...
class Scheme extends ColorScheme {
  ...
  ThemeData get theme => ThemeData(
        ...
        appBarTheme: primaryAppBar
            ? AppBarTheme(
                ...
                titleTextStyle: TextStyle(color: onPrimary, fontSize: 24),
              )
            : AppBarTheme(
                elevation: 0,
                backgroundColor: background,
                ...
                titleTextStyle: TextStyle(
                    color: onBackground, fontSize: 28, letterSpacing: 2),
              ),
        cardColor: onBackground.withOpacity(0.1),
				dividerTheme: DividerThemeData(thickness: 1, color: onBackground.withOpacity(0.05)),
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          filled: true,
          fillColor: onBackground.withOpacity(0.01),
  ...
  TextTheme get textTheme => TextTheme(
        ...
        headline6: TextStyle(color: onBackground, fontSize: 24),
        bodyText1: TextStyle(color: onBackground, fontSize: 16),
        bodyText2: TextStyle(color: onBackground, fontSize: 16),
        ...
        button: TextStyle(color: onBackground, fontSize: 16),
      );
}
